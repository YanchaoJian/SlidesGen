...
# Add Body Text
body_box = slide.shapes.add_textbox(Inches(1.0), Inches(1.5), Inches(4.8), Inches(4.125))
...
if os.path.exists(image_path):
    slide.shapes.add_picture(image_path, Inches(6.0), Inches(1.5), width=Inches(3.0), height=Inches(4.125))
else:
