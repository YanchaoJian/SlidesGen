...
def add_slide(prs):
    ...
    separator_line = slide.shapes.add_connector(
        MSO_CONNECTOR_TYPE.STRAIGHT, Inches(0.5), Inches(1.125), Inches(9.5), Inches(1.125)
    )
    line_format = separator_line.line
    line_format.width = Pt(1)
    line_format.fill.solid()
    line_format.fill.fore_color.rgb = RGBColor(0, 63, 135)
    ...
    figure = slide.shapes.add_picture(
        image_path, Inches(6.5), Inches(1.5), height=Inches(4.5)
    )
