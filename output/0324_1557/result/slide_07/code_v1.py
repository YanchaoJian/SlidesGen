...
def add_slide(prs):
    ...
    title_paragraph.font.color.rgb = RGBColor(0, 63, 135)
    ...
    table_paragraph.font.name = "Microsoft YaHei"
    table_paragraph.font.size = Pt(18)
    table_paragraph.font.color.rgb = RGBColor(51, 51, 51)
