...
def add_slide(prs):
    ...
    header_bar = slide.shapes.add_shape(
        MSO_SHAPE.RECTANGLE, Inches(0), Inches(0), prs.slide_width, Inches(1.125)
    )
    ...
    line = slide.shapes.add_connector(
        MSO_CONNECTOR_TYPE.STRAIGHT, Inches(0.5), Inches(1.125), Inches(9.5), Inches(1.125)
    )
    ...
    footer_text_box = slide.shapes.add_textbox(
        Inches(8.5), prs.slide_height - Inches(0.75), Inches(1.0), Inches(0.5)
    )
    ...
    title_box = slide.shapes.add_textbox(
        Inches(0), Inches(0), prs.slide_width, Inches(1.125)
    )
    title_frame = title_box.text_frame
    title_frame.text = "Solution Overview: The Transformer Model"
    ...
    body_text_box = slide.shapes.add_textbox(
        Inches(0.5), Inches(1.5), Inches(4.5), Inches(3.375)
    )
    body_text_frame = body_text_box.text_frame
    body_text_frame.text = (
        "The Transformer introduces a novel architecture based entirely on attention mechanisms, eliminating recurrence and convolution.\n"
    ...
    body_text_frame.paragraphs[0].font.name = "Microsoft YaHei"
    body_text_frame.paragraphs[0].font.size = Pt(18)
    body_text_frame.paragraphs[0].font.color.rgb = RGBColor(51, 51, 51)
    body_text_frame.paragraphs[0].alignment = PP_ALIGN.LEFT
    ...
    if os.path.exists(image_path):
        image = slide.shapes.add_picture(
            image_path, Inches(5.5), Inches(1.5), width=Inches(3.5), height=Inches(3.375)
        )

        # Image Caption
        caption_box = slide.shapes.add_textbox(
            Inches(5.5), Inches(5.0), Inches(3.5), Inches(0.5)
        )
        caption_frame = caption_box.text_frame
        caption_frame.text = "The Transformer - model architecture."
